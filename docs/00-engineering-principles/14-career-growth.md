...
```mermaid
flowchart LR
    Developer --> Senior[Senior Engineer]
    Senior --> Lead[Technical Lead]
    Lead --> Architect
    Architect --> Principal[Principal Engineer]
    Senior --> Manager[Engineering Manager]
    Manager --> SeniorManager[Senior Engineering Leadership]
    Lead -. collaboration .-> Manager
    Principal -. partnership .-> SeniorManager
```
